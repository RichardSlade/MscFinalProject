...
//------------------------------------------------------------------------
Innovation::Innovation(std::vector<SLinkGene>   start_genes,
...
//------------------------------------------------------------------------
int Innovation::CheckInnovation(int in, int out, innov_type type)
{
...
//------------------------------------------------------------------------
int Innovation::CreateNewInnovation(int in, int out, innov_type type)
{
...
//------------------------------------------------------------------------
int Innovation::CreateNewInnovation(int          from,
                                     int          to,
...
//------------------------------------------------------------------------
SNeuronGene Innovation::CreateNeuronFromID(int NeuronID)
{
