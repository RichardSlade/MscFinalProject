#ifndef INCL_PARTICLE_HPP
#define INCL_PARTICLE_HPP
...
//  void setCanvasSize(sf::Vector2u newSize) { m_canvasSize = newSize; }
  ...
  void fuel(int particles, sf::Color pColour);     /*< Adds new particles */
  void update(sf::Time dt); /*< Updates particles */

  bool isActive(){ return mActive; }
  void setStartPosition(sf::Vector2f startPos){ m_startPos = startPos; }
